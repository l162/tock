...
impl<'a> kernel::InterruptService<DeferredCallTask> for Stm32f403xxDefaultPeripherals<'a> {
    unsafe fn service_interrupt(&self, interrupt: u32) -> bool {
        match interrupt {
            // put Stm32f403xx specific interrupts here
