...
const FLASH_BASE: StaticRef<FlashRegisters> =
    unsafe { StaticRef::new(BASE_ADDRESS as *const FlashRegisters) };
...
/// # use stm32f303xc::flash::StmF4Page;
/// # use kernel::static_init;
///
/// let pagebuffer = unsafe { static_init!(StmF4Page, StmF4Page::default()) };
/// ```
pub struct StmF4Page(pub [u8; PAGE_SIZE as usize]);
...
impl FlashController {
    pub const fn new(base_addr: usize) -> FlashController {
        FlashController {
