...
//static mut CHIP: Option<&'static stm32f4::chip::Stm32f4xx<Stm32f412gDefaultPeripherals>> = None;
static mut CHIP: Option<&'static stm32f4::chip::Stm32f4xx<Stm32f403xxDefaultPeripherals>> = None;
//use stm32f4::interrupt_service::Stm32f412gDefaultPeripherals;
use stm32f4::interrupt_service::Stm32f403xxDefaultPeripherals;
...
struct STM32F4Discovery {
    ...
    ipc: kernel::ipc::IPC,
    led: &'static capsules::led::LedDriver<'static, LedLow<'static, stm32f4::gpio::Pin<'static>>>,
    button: &'static capsules::button::Button<'static, stm32f4::gpio::Pin<'static>>,

    alarm: &'static capsules::alarm::AlarmDriver<
        'static,
        VirtualMuxAlarm<'static, stm32f4::tim2::Tim2<'static>>,
    >,
    gpio: &'static capsules::gpio::GPIO<'static, stm32f4::gpio::Pin<'static>>,
...
unsafe fn setup_dma(
    dma: &stm32f4::dma1::Dma1,
    dma_streams: &'static [stm32f4::dma1::Stream; 8],
    usart2: &'static stm32f4::usart::Usart,
) {
    use stm32f4::dma1::Dma1Peripheral;
    use stm32f4::usart;
...
unsafe fn set_pin_primary_functions(
    syscfg: &stm32f4::syscfg::Syscfg,
    exti: &stm32f4::exti::Exti,
    i2c1: &stm32f4::i2c::I2C,
    gpio_ports: &'static stm32f4::gpio::GpioPorts<'static>,
) {
    use kernel::hil::gpio::Configure;
    use stm32f4::exti::LineId;
    use stm32f4::gpio::{AlternateFunction, Mode, PinId, PortId};
    ...
    // cortexm4::nvic::Nvic::new(stm32f4::nvic::EXTI0).enable();
    ...
    cortexm4::nvic::Nvic::new(stm32f4::nvic::EXTI1).enable();
    ...
    cortexm4::nvic::Nvic::new(stm32f4::nvic::EXTI15_10).enable();
    ...
    i2c1.enable_clock();
    i2c1.set_speed(stm32f4::i2c::I2CSpeed::Speed100k, 16);
    ...
    gpio_ports.get_pin(PinId::PA01).map(|pin| {
        pin.set_mode(stm32f4::gpio::Mode::AnalogMode);
    });
    ...
    cortexm4::nvic::Nvic::new(stm32f4::nvic::EXTI9_5).enable();
    ...
    for pin in pins.iter() {
        gpio_ports.get_pin(*pin).map(|pin| {
            pin.set_mode(stm32f4::gpio::Mode::AlternateFunctionMode);
            pin.set_floating_state(gpio::FloatingState::PullUp);
            pin.set_speed();
            pin.set_alternate_function(stm32f4::gpio::AlternateFunction::AF12);
        });
    }
...
unsafe fn setup_peripherals(tim2: &stm32f4::tim2::Tim2, fsmc: &stm32f4::fsmc::Fsmc) {
    // USART2 IRQn is 38
    cortexm4::nvic::Nvic::new(stm32f4::nvic::USART2).enable();

    // TIM2 IRQn is 28
    tim2.enable_clock();
    tim2.start();
    cortexm4::nvic::Nvic::new(stm32f4::nvic::TIM2).enable();
...
pub unsafe fn reset_handler() {
    ...
    let rcc = static_init!(stm32f4::rcc::Rcc, stm32f4::rcc::Rcc::new());
    let syscfg = static_init!(stm32f4::syscfg::Syscfg, stm32f4::syscfg::Syscfg::new(rcc));
    let exti = static_init!(stm32f4::exti::Exti, stm32f4::exti::Exti::new(syscfg));
    let dma1 = static_init!(stm32f4::dma1::Dma1, stm32f4::dma1::Dma1::new(rcc));

    let peripherals = static_init!(
        //Stm32f412gDefaultPeripherals,
        //Stm32f412gDefaultPeripherals::new(rcc, exti, dma1)
        Stm32f403xxDefaultPeripherals,
        Stm32f403xxDefaultPeripherals::new(rcc, exti, dma1)
    );
    peripherals.init();
    ...
    let chip = static_init!(
        stm32f4::chip::Stm32f4xx<Stm32f403xxDefaultPeripherals>,
        stm32f4::chip::Stm32f4xx::new(peripherals)
    );
    CHIP = Some(chip);
    ...
    let led = components::led::LedsComponent::new(components::led_component_helper!(
        LedLow<'static, stm32f4::gpio::Pin>,
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::P013)
                //.get_pin(stm32f4::gpio::PinId::PE00)
                .get_pin(stm32f4::gpio::PinId::PG13)
                .unwrap()
        ),
        //LedLow::new(
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE01)
                //.get_pin(stm32f4::gpio::PinId::PG14)
                .get_pin(stm32f4::gpio::PinId::PD14)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE02)
                //.get_pin(stm32f4::gpio::PinId::PG15)
                .get_pin(stm32f4::gpio::PinId::PD15)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE03)
                .get_pin(stm32f4::gpio::PinId::PD13)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE03)
                .get_pin(stm32f4::gpio::PinId::PD12)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE03)
                .get_pin(stm32f4::gpio::PinId::PD11)
                .unwrap()
        ),
        LedLow::new(
            base_peripherals
                .gpio_ports
                //.get_pin(stm32f4::gpio::PinId::PE03)
                .get_pin(stm32f4::gpio::PinId::PD10)
                .unwrap()
        ),
    ))
        ...
        components::button_component_helper!(
            ...
            (
                base_peripherals
                    .gpio_ports
                    //.get_pin(stm32f4::gpio::PinId::PD13)
                    .get_pin(stm32f4::gpio::PinId::PG00)
                    .unwrap(),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32f4::gpio::PinId::PG01)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32f4::gpio::PinId::PF15)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
            ...
            (
                base_peripherals
                    .gpio_ports
                    .get_pin(stm32f4::gpio::PinId::PF14)
                    .unwrap(),
                kernel::hil::gpio::ActivationMode::ActiveHigh,
                kernel::hil::gpio::FloatingState::PullNone
            ),
    ...
    .finalize(components::button_component_buf!(stm32f4::gpio::Pin));

    // ALARM

    let tim2 = &base_peripherals.tim2;
    let mux_alarm = components::alarm::AlarmMuxComponent::new(tim2)
        .finalize(components::alarm_mux_component_helper!(stm32f4::tim2::Tim2));

    let alarm = components::alarm::AlarmDriverComponent::new(board_kernel, mux_alarm)
        .finalize(components::alarm_component_helper!(stm32f4::tim2::Tim2));
    ...
    let gpio = GpioComponent::new(
        ...
        components::gpio_component_helper!(
            stm32f4::gpio::Pin,
            // Arduino like RX/TX
            0 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG09).unwrap(), //D0
            1 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG14).unwrap(), //D1
            2 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG13).unwrap(), //D2
            3 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PF04).unwrap(), //D3
            4 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG12).unwrap(), //D4
            5 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PF10).unwrap(), //D5
            6 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PF03).unwrap(), //D6
            7 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG11).unwrap(), //D7
            8 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PG10).unwrap(), //D8
            9 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PB08).unwrap(), //D9
            // SPI Pins
            10 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PA15).unwrap(), //D10
            11 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PA07).unwrap(),  //D11
            12 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PA06).unwrap(),  //D12
            13 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PA15).unwrap(), //D13

            // ADC Pins
            // Enable the to use the ADC pins as GPIO
             14 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PA01).unwrap(), //A0
             15 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PC01).unwrap(), //A1
             16 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PC03).unwrap(), //A2
             17 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PC04).unwrap(), //A3
             19 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PC05).unwrap(), //A4
             20 => base_peripherals.gpio_ports.get_pin(stm32f4::gpio::PinId::PB00).unwrap() //A5
        ),
    )
    .finalize(components::gpio_component_buf!(stm32f4::gpio::Pin));
    ...
    let ft6x06 = components::ft6x06::Ft6x06Component::new(
        base_peripherals
            .gpio_ports
            .get_pin(stm32f4::gpio::PinId::PG05)
            .unwrap(),
    )
    ...
    */
    ...
    let tft = components::st77xx::ST77XXComponent::new(mux_alarm).finalize(
        components::st77xx_component_helper!(
            ...
            // bus type
            capsules::bus::Bus8080Bus<'static, stm32f4::fsmc::Fsmc>,
            // bus
            &bus,
            // timer type
            stm32f4::tim2::Tim2,
    ...
    */
    ...
    let adc_mux = components::adc::AdcMuxComponent::new(&base_peripherals.adc1)
        .finalize(components::adc_mux_component_helper!(stm32f4::adc::Adc));
    ...
    let adc_channel_0 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel1)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));

    let adc_channel_1 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel11)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));

    let adc_channel_2 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel13)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));

    let adc_channel_3 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel14)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));

    let adc_channel_4 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel15)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));

    let adc_channel_5 =
        components::adc::AdcComponent::new(&adc_mux, stm32f4::adc::Channel::Channel8)
            .finalize(components::adc_component_helper!(stm32f4::adc::Adc));
    ...
    let nonvolatile_storage = components::nonvolatile_storage::NonvolatileStorageComponent::new(
        board_kernel,
        &base_peripherals.flash, //&peripherals.flash, //&stm32f4::flash::Flash::new(),
        // &peripherals.stm32f403xx.flash,
        // &peripherals.stm32f4.flash,
...
pub unsafe fn reset_handler() {
    ...
    let syscfg = static_init!(
        stm32f4::syscfg::Syscfg,
        stm32f4::syscfg::Syscfg::new(rcc)
    );
    let exti = static_init!(stm32f4::exti::Exti, stm32f4::exti::Exti::new(syscfg));
    let dma1 = static_init!(stm32f4::dma1::Dma1, stm32f4::dma1::Dma1::new(rcc));
    ...
    let chip = static_init!(
        stm32f4::chip::Stm32f4xx<Stm32f412gDefaultPeripherals>,
        stm32f4::chip::Stm32f4xx::new(peripherals)
    );
    CHIP = Some(chip);
}
